...
[Стабильная](https://d.defold.com/stable/) — это уже протестированная версия, которая отправляется всем пользователям. Обновляться на нее совсем не страшно. Поломки, если и случаются, то крайне редко и быстро исправляются. По ссылке есть рантаймы и ресурсы для билдов, для каждой версии движка под все платформы.

[Alpha](https://d.defold.com/alpha/) — ранняя и неоттестированная версия с новыми фичами.

[Beta](https://d.defold.com/beta/) — версия, которая проходит тестирование перед релизом.
