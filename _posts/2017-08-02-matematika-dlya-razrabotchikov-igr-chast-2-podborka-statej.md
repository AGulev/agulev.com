...
- [обзорный доклад](https://www.gdcvault.com/play/1017922/Math-for-Game) **(eng)** с GDC о том, где же в играх математика, зачем она нужна и как ее использовать.
...
- статьи с интерактивными примерами о том, как работает физика и как написать свой физический движок для 2d игры:
  ...
  - [определение столкновений для объектов различных форм](https://www.jeffreythompson.org/collision-detection/table_of_contents.php).
