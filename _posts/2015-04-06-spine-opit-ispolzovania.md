...
>
> У программы много отличных возможностей, о которых вы можете узнать на [офф. сайте](https://ru.esotericsoftware.com/spine-in-depth#Features), я же расскажу про свой опыт.
>
...
Есть событие Complete анимации, а так же в самом редакторе, аниматор может [расставить свои события](https://ru.esotericsoftware.com/spine-events), подобно тому, как это делается в unity.
