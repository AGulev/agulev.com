...
- Facebook интегрируется один раз и работает на iOS, Android, HTML5 ([ссылка на мануал](https://defold.com/manuals/facebook/));
- In-app purchases — интегрируются один раз и работают на iOS, Android, HTML5 (Facebook canvas) и Amazon ([ссылка на мануал](https://defold.com/manuals/iap/))
- Push Notification интегрируются один раз и работают на iOS, Android ([ссылка на мануал](https://defold.com/manuals/push/)).
