...
Для простоты импортирования готовых атласов в Assets Store есть специальный плагин: [TexturePacker Importer.](https://assetstore.unity3d.com/en/#!/content/16641) Все делается в немколько кликов.
