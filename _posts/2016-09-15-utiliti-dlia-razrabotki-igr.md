...
Оказывается, не все знают про замечательную утилиту [TexturePacker](https://codeandweb.com/texturepacker). Мне всегда казалось, что это программа «по умолчанию» для всех разработчиков игр и я очень к этому привык.
...
Для простоты импортирования готовых атласов в Assets Store есть специальный плагин: [TexturePacker Importer.](https://assetstore.unity.com/packages/tools/sprite-management/texturepacker-importer-16641?srsltid=AfmBOoouNEASGyT0vu_PtEDwKcfaXkNmSDj7ZHBNTUMqhaP3IxWYk6bI) Все делается в немколько кликов.
...
[SpriteIlluminator](https://codeandweb.com/spriteilluminator) — программа для генирации карт нормалей используемых для освещения в 2d играх.

[PhysicsEditor](https://codeandweb.com/physicseditor) — программа для создания физических объектов по изображения.
...
[Саша — геймдизайнер](https://facebook.com/profile.php?id=100007526448882&fref=ts), с которым я работаю, [над текущей игрой](https://bring-me-cakes.com), остался очень доволен простотой, функциональностью и легкостью Tiled (очень маленький и быстрый редактор).
