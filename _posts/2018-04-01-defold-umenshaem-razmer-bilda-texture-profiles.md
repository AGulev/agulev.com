...
Давайте коротко рассмотрим форматы текстур, которые можно использовать для нашей задачи ([полное описание есть в документации](https://defold.com/manuals/texture-profiles/#_texture_formats)):
...
Подробнее о сжатии [в документации](https://defold.com/manuals/texture-profiles/#_compression_types), а вот мой краткий обзор:
...
- используйте slice-9 текстуры в GUI там, где это возможно ([подробнее о том, что это](https://defold.com/manuals/gui/#_slice_9_texturing));
...
- используйте опцию [Compress Archive](https://defold.com/manuals/project-settings/#_project) в настройках проекта;
