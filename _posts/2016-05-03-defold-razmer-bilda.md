...
Продолжаю замерять размеры [билдов на различных технологиях](/kogda-razmer-ipa-i-apk-imeet-znachenie/). Посмотрим на движок от King — [Defold](https://www.defold.com).
...
Надеюсь, в будущем появится возможность отключения неиспользуемых модулей (ручная, как в [cocos2djs](https://www.cocos2d-x.org/filecenter/jsbuilder), или автоматическая), а пока для разработчиков небольших HTML5 игр Defold не очень подходит.
