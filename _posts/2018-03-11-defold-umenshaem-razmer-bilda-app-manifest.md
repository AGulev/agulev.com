...
- на сэкономленное место можно внедрить рекламу (если это небольшой нативный плагин, к примеру [Unity ADS для Defold](https://defold.com/community/projects/65114/)) или еще что-то необходимое.
