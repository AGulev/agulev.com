...
- на сэкономленное место можно внедрить рекламу (если это небольшой нативный плагин, к примеру [Unity ADS для Defold](https://defold.com/assets/defvideoads/)) или еще что-то необходимое.
