...
Где-то полтора месяца назад я впервые запустил [Defold](https://www.defold.com) и переодически посматривал на его возможности в свободное время.
...
Еще порадовало, что в движке есть [hot reload](https://www.defold.com/manuals/debugging/#anchor-hr). Я видел много презентаций и роликов о том, как это круто. Но так и не видел, чтобы это работало хорошо и просто. В Defold с этим проблем нет как в локальном билде, так и на телефоне.
...
- [рендер скрипты](https://www.defold.com/manuals/rendering/);
- [система сообщений](https://www.defold.com/manuals/message-passing/);
- [работа с материалами](https://www.defold.com/manuals/materials/);
- [классное комьюнити](https://forum.defold.com);
- [обширная документация](https://www.defold.com/learn/) и т.д.
